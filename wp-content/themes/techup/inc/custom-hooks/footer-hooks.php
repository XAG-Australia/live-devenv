...
if( ! function_exists( 'techup_footer_sidebar' ) ):
	...
	<ul class="list-inline mb-0">
		  <li class="list-inline-item g-mx-5">
            <a class="" href="#!">
              <i class="" style="max-height: 50px !important; margin-left: -5px;"><img src="/media/know-your-drone-safety-advocate-colour.jpg" style="max-height: 50px !important; margin-top: 25px;"></i>
            </a>
          </li>
        </ul>
      <!-- End Footer Content -->
      ...
      <!-- End Footer Content -->
			...
			<?php echo '©' ?> <?php bloginfo( 'name' ); ?> <?php echo '2023' ?> <?php echo '<img src="/media/know-your-drone-safety-advocate-colour.jpg" style="max-height: 40px !important; float: right; margin-left: 50px;">' ?>
	</div>
	<?php }
endif;
