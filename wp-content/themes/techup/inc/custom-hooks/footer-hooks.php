...
if( ! function_exists( 'techup_footer_sidebar' ) ):
	...
	<ul class="list-inline mb-0">
      ...
      <!-- End Footer Content -->
			...
			<?php echo '©' ?> <?php bloginfo( 'name' ); ?> <?php echo '2023' ?> <?php echo '<img src="/media/know-your-drone-safety-advocate-colour.jpg" style="max-height: 50px !important; margin-top: 25px; float: right;">' ?>
	</div>
	<?php }
endif;
